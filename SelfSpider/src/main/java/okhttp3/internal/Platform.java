...
public class Platform {
    ...
    private static Platform findPlatform() {
        ...
        try {
            ...
            try {
                Class.forName("android.net.Network"); // Arbitrary class added
                // in Android 5.0.
     ...
     *
     * @param hostname non-null for client-side handshakes; null for server-side
     *                 handshakes.
     */
    ...
    private static class Android extends Platform {
        ...
        public Android(Class<?> sslParametersClass, OptionalMethod<Socket> setUseSessionTickets, OptionalMethod<Socket> setHostname,
        ...
        public void connectSocket(Socket socket, InetSocketAddress address, int connectTimeout) throws IOException {
            ...
            try {
                ...
                // Before android 4.3, socket.connect could throw a
                // SecurityException
        ...
        public X509TrustManager trustManager(SSLSocketFactory sslSocketFactory) {
            ...
            if (context == null) {
                // If that didn't work, try the Google Play Services SSL
                // provider before giving up. This
    ...
    /**
     * OpenJDK 7+ with {@code org.mortbay.jetty.alpn/alpn-boot} in the boot
     * class path.
     */
    private static class JdkWithJettyBootPlatform extends Platform {
        ...
        public String getSelectedProtocol(SSLSocket socket) {
            ...
            try {
                JettyNegoProvider provider = (JettyNegoProvider) Proxy.getInvocationHandler(getMethod.invoke(null, socket));
    ...
    /**
     * Handle the methods of ALPN's ClientProvider and ServerProvider without a
     * compile-time dependency on those interfaces.
     */
    private static class JettyNegoProvider implements InvocationHandler {
        ...
        public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
            ...
            if (methodName.equals("supports") && boolean.class == returnType) {
            ...
            } else if ((methodName.equals("selectProtocol") || methodName.equals("select")) && String.class == returnType && args.length == 1
                ...
                return selected = protocols.get(0); // On no intersection, try
                // peer's first
                // protocol.
            } else if ((methodName.equals("protocolSelected") || methodName.equals("selected")) && args.length == 1) {
                this.selected = (String) args[0]; // Server selected this
                // protocol.
                return null;
            } else {
