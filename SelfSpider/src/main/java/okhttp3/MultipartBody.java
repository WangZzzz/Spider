...
/**
 * An <a href="http://www.ietf.org/rfc/rfc2387.txt">RFC 2387</a>-compliant
 * request body.
 */
public final class MultipartBody extends RequestBody {
     ...
     * {@code Content-Type} value for a body part is changed from "text/plain"
     * to "message/rfc822".
     */
    ...
    /**
     * Either writes this request to {@code sink} or measures its content
     * length. We have one method do double-duty to make sure the counting and
     * content are consistent, particularly when it comes to awkward operations
     * like measuring the encoded length of header strings, or the
    ...
    private long writeOrCountBytes(BufferedSink sink, boolean countBytes) throws IOException {
        ...
        for (int p = 0, partCount = parts.size(); p < partCount; p++) {
            ...
            if (contentLength != -1) {
                ...
                // We can't measure the body's size without the sizes of its
                // components.
    ...
    public static final class Builder {
         ...
         * {@link #MIXED} (the default), {@link #ALTERNATIVE}, {@link #DIGEST},
         * {@link #PARALLEL} and {@link #FORM}.
         */
